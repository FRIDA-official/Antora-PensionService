...
Benutzer seine sichtbaren Verträge konfigurieren, auf die auf auch die
...
daraus die Rentenhöhe, die dann an den Kunden zurückgegeben wird.  +
 +

++++
include::partial$FRIDA_PensionInformation_OA3_full_en.html[style="max-width:100rem"]
++++
