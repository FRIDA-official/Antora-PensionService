...
image::component-pension:User_de.png[Image not found]
...
image::component-pension:Auth_de.png[Image not found]
...
== Rentenberechnung
  ...
  image::component-pension:Case1_de.png[Image not found]
...
include::index.adoc[implement of an API]
